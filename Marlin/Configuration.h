...
#define STRING_CONFIG_H_AUTHOR "(Mr.2k9, Custom Config)" // Who made the changes.
 ...
 */
#define X_DRIVER_TYPE  TMC2208_STANDALONE //Default on Tronxy XY2-Pro TMC2225
#define Y_DRIVER_TYPE  TMC2208_STANDALONE //Default on Tronxy XY2-Pro TMC2225
#define Z_DRIVER_TYPE  TMC2208_STANDALONE //Default on Tronxy XY2-Pro TMC2225
...
#define E0_DRIVER_TYPE TMC2208_STANDALONE //Default on Tronxy XY2-Pro TMC2225
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 189.59
  #define DEFAULT_bedKi 35.89
  #define DEFAULT_bedKd 667.08
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 1105.56 } //Voron M4 estep. Titan e-step is 799
...
#define MAG_MOUNTED_PROBE
  ...
  #define MAG_MOUNTED_DEPLOY_1 { PROBE_DEPLOY_FEEDRATE, { 255, 127.5, 20 } }  // Move to side Dock & Attach probe
  #define MAG_MOUNTED_DEPLOY_2 { PROBE_DEPLOY_FEEDRATE, { 210, 127.5, 20 } }  // Move probe off dock
  //#define MAG_MOUNTED_DEPLOY_3 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  //#define MAG_MOUNTED_DEPLOY_4 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  //#define MAG_MOUNTED_DEPLOY_5 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  #define MAG_MOUNTED_STOW_1   { PROBE_STOW_FEEDRATE,   { 255, 127.5, 20 } }  // Move to dock
  #define MAG_MOUNTED_STOW_2   { PROBE_STOW_FEEDRATE,   { 255, 127.5,  0 } }  // Place probe beside remover
  #define MAG_MOUNTED_STOW_3   { PROBE_STOW_FEEDRATE,   { 210, 127.5,  0 } }  // Side move to remove probe
  #define MAG_MOUNTED_STOW_4   { PROBE_STOW_FEEDRATE,   { 210, 127.5, 20 } }  // Side move to remove probe
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 22.5, 23.1, 0 } //Custom Klackender Mount
...
#define INVERT_E0_DIR false //Voron M4 DIY Mount. true for default titan extruder

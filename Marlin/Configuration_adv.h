...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  25, 25 }, { 230,  25 }, { 230, 230 }, { 25, 230 } } // Tronxy Screw Location
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.7 }    // (mm) Compression length per 1mm/s extruder speed, per extruder. tested with Ellis3D Tuning Guide. 
  #else
